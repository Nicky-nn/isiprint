...
export function AnimatedLogo({ 
  ...
  const paths = [
    `M5080 7233 c-81 -8 -312 -54 -395 -78 -436 -125 -833 -377 -1128
...
-846 603 -1358 670 -108 14 -445 19 -547 8z`,
    `M5787 5400 c-104 -27 -179 -90 -226 -190 -20 -44 -25 -70 -25 -132 1
-134 69 -238 194 -297 46 -22 68 -26 135 -25 119 2 207 50 269 147 82 130 71
277 -30 395 -68 80 -215 127 -317 102z`,
    `M4731 5379 c-86 -17 -181 -92 -223 -178 -18 -38 -23 -63 -23 -141 0
  ...
  return (
    <div style={{ 
      ...
      <motion.div
        ...
        animate={isAnimated ? { scale: [1, 1.02, 1] } : undefined}
        transition={isAnimated ? { duration: 2, repeat: Infinity, ease: "easeInOut" } : undefined}
      >
        <motion.svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1021 793"
          style={{ width: '100%', height: '100%' }}
          animate={isAnimated ? "draw" : "static"}
        >
          <g transform="translate(0,793) scale(0.1,-0.1)">
            {paths.map((d, i) => (
              <motion.path
                key={i}
                d={d}
                fill={isAnimated ? 'transparent' : color}
                stroke={color}
                strokeWidth={isAnimated ? '50px' : '0'}
                variants={pathVariants}
                style={!isAnimated ? { fill: color } : undefined}
              />
            ))}
          </g>
        </motion.svg>
        ...
        >
          <motion.div
            style={{
              ...
              height: '100%',
              borderRadius: '2px',
              background: 'linear-gradient(90deg, #88FCA4, #F8FD67)',
            }}
            animate={{
              x: ['-100%', '350%']
            }}
...
// Static logo version (filled)
export function StaticLogo({ size = 40, color = "#88FCA4" }: { size?: number; color?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1021 793"
      style={{ width: size, height: size }}
    >
      <g transform="translate(0,793) scale(0.1,-0.1)" fill={color}>
